...
void swapStr(vector <string> *svec){
	...
	while (a != 0){
		cout << endl
			<< "1. Заменить строку в векторе" << endl
			<< "2. Заменить строку в файле" << endl
			<< "0. Выход" << endl
			<< endl;
		cin >> a;
		...
		if (a == 1)
			if (svec->empty())
				...
				while (n1 != 0){
					...
					if (n1 == 1){
						...
						cout << "Введите номер строки которую хотели бы заменить: ";
						cin >> pos;
						cout << endl << "Введите строку:" << endl;
						getchar();
						getline(cin, user_str);
						loc_svec[pos-1] = user_str;

						cout << "Данные в буфере:" << endl;
						for (size_t i = 0; i != size_svec; ++i)
							cout << loc_svec[i] << endl;	
					}
					else if (n1 == 2){
						cout << "Успешно сохраненно. Теперь данные в векторе:" << endl;
						svec->clear();
			...
			cout << "Введите имя файла и его разрешение (Пример: text.txt), который собираетесь изменять: ";
			string name_f;
			cin >> name_f;
			...
			while (n2 != 0){
				///Меню
				cout << endl
					<< "1. Заменить строку в файле" << endl
					<< "2. Сохранить" << endl
					<< "0. Выход" << endl
					<< endl;
					cin >> n2;
					if (n2 == 1){
						...
						cout << "Успешно сохраненно. Теперь данные файла:" << endl;
						for (size_t i = 0; i != size_text; ++i){
							file << text[i] << endl;
							cout << text[i] << endl;
						}
